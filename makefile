...
segmentation_app:test_segmentation.o word_segmentation.o
	$(CC) -g -finput-charset=GB2312 test_segmentation.o word_segmentation.o -o segmentation_app

test_segmentation.o:test_segmentation.cpp word_segmentation.hpp
	$(CC) -g -finput-charset=GB2312 test_segmentation.cpp  -c

word_segmentation.o:word_segmentation.cpp word_segmentation.hpp
    $(CC) -g -finput-charset=GB2312 word_segmentation.cpp  -c
# 删除生成文件
cleanall:
